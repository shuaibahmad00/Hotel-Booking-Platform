...
const RoomDetails = () => {
    ...
    //on submit handler function to check  the availability and book the room
  ...
  return (
    <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32 '>
      ...
      <div>
        ...
        <div className='flex flex-col lg:flex-row mt-6 gap-6'>
            ...
            <div className='grid grid-cols-2 gap-4 lg:w-1/2 w-full'>
                {room?.images.length > 1 && room.images.map((image, index) => (
                    ...
                    src={image} alt="Room Image" key={index} className={`w-full rounded-xl shadow-md object-cover cursort-pointer ${mainImage === image && 'outline-3 outline-orange-500 '}`}/>
                ))}
            </div>
        </div>
        ...
        <button type='submti' className='bg-primary hover:bg-primary-dull active:scale-95 transition-all text-white rounded-md max-md:w-full max-md:mt-6 md:px-25 py-3 md:py-4 text-base cursor-pointer'>
